...
(function () {
    ...
    openerp.website.RTE = openerp.website.RTE.extend({
        _config: function () {
            ...
            config.colorButton_colors = 'ffffff,000000,eeeeee,64a70b,ff6332';
            ...
            config.stylesSet = [
                ...
                {name: 'p Klein', element: 'p', attributes: { 'class': 'arno_small' } },
                {name: 'p Winzig', element: 'p', attributes: { 'class': 'arno_tiny' } },
                {name: 'H1', element: 'h1'},
                {name: 'H2', element: 'h2'},
                {name: 'H3', element: 'h3'},
                {name: 'H4', element: 'h4'},
                ...
                // {name: 'Klein', element: 'span', attributes: { 'class': 'arno_small_text' } },
                // {name: 'Sehr-Klein', element: 'span', attributes: { 'class': 'arno_very_small_text' } },
            ];
